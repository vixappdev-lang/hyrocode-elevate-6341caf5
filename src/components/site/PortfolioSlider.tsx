...
const projects: Project[] = [
  { img: p1, name: "Clínica Sorriso Bem Estar", category: "Clínica Odontológica" },
  ...
  { img: p5, name: "Almeida & Ribeiro Advogados", category: "Advocacia" },
    ...
    <section id="portfolio" className="relative py-20 sm:py-24 lg:py-28">
      <div ref={ref} className="reveal mx-auto max-w-3xl px-6 text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-base">
          ...
          Sites pensados para vender, agendar e gerar autoridade.
        </p>
      </div>
          ...
          {loop.map((p, i) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(60% 50% at 50% 50%, color-mix(in oklab, var(--primary) 18%, transparent), transparent 70%)",
                }}
              />
